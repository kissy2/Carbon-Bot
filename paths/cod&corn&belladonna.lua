...
function move()
	return {
		...
		{map = "-45,20", changeMap = "top", gather = true},
		{map = "-44,21", changeMap = "top", gather = true},
		{map = "-45,21", changeMap = "top", gather = true},
		{map = "-46,22", changeMap = "top", gather = true},
		...
		{map = "-46,13", changeMap = "top", gather = true},
		{map = "-47,11", changeMap = "top", gather = true},
		...
		{map = "-49,7", changeMap = "top", gather = true},
		...
		{map = "-53,2", changeMap = "top", gather = true},
		{map = "-52,-1", changeMap = "top", gather = true},
		{map = "-52,-2", changeMap = "top", gather = true},
		{map = "-55,-1", changeMap = "top", gather = true},
		{map = "-57,2", changeMap = "top", gather = true},
		{map = "-59,1", changeMap = "top", gather = true},
		{map = "-60,2", changeMap = "top", gather = true},
		{map = "-60,5", changeMap = "top", gather = true},
		{map = "-58,6", changeMap = "top", gather = true},
		{map = "-58,7", changeMap = "top", gather = true},
		{map = "-58,9", changeMap = "top", gather = true},
		{map = "-59,9", changeMap = "top", gather = true},
		{map = "-58,10", changeMap = "top", gather = true},
		{map = "-58,11", changeMap = "top", gather = true},
