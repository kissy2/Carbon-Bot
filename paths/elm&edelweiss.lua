...
function move()
	return {
		...
		{map = "-1,13", changeMap = "top", gather = true},
		{map = "4,16", changeMap = "top", gather = true},
		{map = "-1,25", changeMap = "top", gather = true},
		{map = "-5,24", changeMap = "top", gather = true},
		{map = "-6,24", changeMap = "top", gather = true},
		{map = "-7,25", changeMap = "top", gather = true},
		{map = "-7,27", changeMap = "top", gather = true},
		{map = "-5,26<br><span style="font-size:12px;font-weight:normal;">Toward Dreggon Tunnels 2</span>", changeMap = ""},
		{map = "-4,26", changeMap = "top", gather = true},
		{map = "-2,28", changeMap = "top", gather = true},
		{map = "0,31", changeMap = "top", gather = true},
		{map = "-2,31", changeMap = "top", gather = true},
		{map = "-2,34", changeMap = "top", gather = true},
		{map = "-1,34", changeMap = "top", gather = true},
		{map = "-1,32", changeMap = "top", gather = true},
		{map = "1,32", changeMap = "top", gather = true},
		{map = "1,33", changeMap = "top", gather = true},
		{map = "0,33", changeMap = "top", gather = true},
	}
end
