...
function move()
	return {
		...
		{map = "-20,-20", changeMap = "top", gather = true},
		{map = "-22,-26", changeMap = "top", gather = true},
		{map = "-24,-16", changeMap = "top", gather = true},
		{map = "-17,-7", changeMap = "top", gather = true},
		{map = "-16,-8", changeMap = "top", gather = true},
		{map = "-15,-9", changeMap = "top", gather = true},
		{map = "-15,-5", changeMap = "top", gather = true},
		{map = "-16,-4", changeMap = "top", gather = true},
		{map = "-21,-4", changeMap = "top", gather = true},
		{map = "-21,-3", changeMap = "top", gather = true},
		...
		{map = "-11,11", changeMap = "top", gather = true},
		{map = "-11,12", changeMap = "top", gather = true},
